...
"""
outcome_surveys documentation build configuration file.
...
html_theme_options = {
    ...
    "repository_url": 'https://github.com/edx/outcome-surveys',
...
#
# html_title = 'outcome_surveys v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Outcome Surveys',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'outcome_surveys'),
                os.path.join(root_path, 'outcome_surveys/migrations')])
